					...
					<form>
						<div class="form-row">
							...
							<div class="form-group col-md-2">
								<label for="cpf"><h3>CPF</h3></label> <input type="text"
									class="form-control" id="cpf"
									pattern="[0-9]{3}.[0-9]{3}.[0-9]{3}-[0-9]{2}"
									placeholder="XXX.XXX.XXX-XX" required="required">
							</div>
							<div class="form-group col-md-4">
								<label for="dateBirthday"><h3>Data de Nascimento</h3></label> <input
									type="date" class="form-control" id="dateBirthday">
							</div>
						</div>
						...
						<div class="form-row">
							...
							<div class="form-group col-md-4">
								<label for="address"><h3>Logradouro</h3></label> <input
									class="form-control" type="number" id="address"
